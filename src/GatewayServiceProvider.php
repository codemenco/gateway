...
class GatewayServiceProvider extends ServiceProvider
{
    ...
    private function getProvider()
    {
        if (version_compare(\Illuminate\Foundation\Application::VERSION, '5.0', '<')) {
            $provider = 'Codemenco\Gateway\GatewayServiceProviderLaravel4';
            ...
            $provider = 'Codemenco\Gateway\GatewayServiceProviderLaravel5';
        }else {
            $provider = 'Codemenco\Gateway\GatewayServiceProviderLaravel6';
        }
